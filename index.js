...
// checkPage(); // Вызываем функцию при загрузке страницы
/*=============PRELOADER=================*/
...
function showSlides2() {
  ...
  for (let i = 0; i < slides2.length; i++) {
    slides2[i].classList.remove("active", "slide-out2");
  }
  slideIndex2++;
  ...
  setTimeout(function() {
    slides2[slideIndex2 - 1].classList.add("slide-out2");
...
//   { title: "Курка з сиром", id: 8, ingridients: "томатна основа, моцарела, куряча шинка, ковбаса, ананас, помідори, кукурудза", price_little: 250, price_big: 350, picture: "images/menu_pizza1.png" },
//   { title: "Маргарита", id: 9, ingridients: "томатна основа, моцарела, куряча шинка, ковбаса, ананас, помідори, кукурудза", price_little: 250, price_big: 350, picture: "images/menu_pizza2.png" },
//   { title: "Селянська", id: 10, ingridients: "томатна основа, моцарела, куряча шинка, ковбаса, ананас, помідори, кукурудза", price_little: 250, price_big: 350, picture: "images/menu_pizza3.png" },
//   { title: "Барбекю", id: 11, ingridients: "томатна основа, моцарела, куряча шинка, ковбаса, ананас, помідори, кукурудза", price_little: 250, price_big: 350, picture: "images/menu_pizza4.png" },
//   { title: "Овочева", id: 12, ingridients: "томатна основа, моцарела, куряча шинка, ковбаса, ананас, помідори, кукурудза", price_little: 250, price_big: 350, picture: "images/menu_pizza7.png" },
//   { title: "Кантрі", id: 13, ingridients: "томатна основа, моцарела, куряча шинка, ковбаса, ананас, помідори, кукурудза", price_little: 250, price_big: 350, picture: "images/menu_pizza5.png" },
//   { title: "Салямі", id: 14, ingridients: "томатна основа, моцарела, куряча шинка, ковбаса, ананас, помідори, кукурудза", price_little: 250, price_big: 350, picture: "images/menu_pizza3.png" },
//   { title: "Чікен_Чорізо", id: 15, ingridients: "томатна основа, моцарела, куряча шинка, ковбаса, ананас, помідори, кукурудза", price_little: 250, price_big: 350, picture: "images/menu_pizza7.png" },
